...
{
	/* Assign all the GPIO pins to secure world by default */
	mmio_write_32(GPIO1_BASE + 0x10, 0x0);
	mmio_write_32(GPIO1_BASE + 0x14, 0x0);
	mmio_write_32(GPIO1_BASE + 0x18, 0xffffffff);
	mmio_write_32(GPIO1_BASE + 0x1c, 0x3);

	mmio_write_32(GPIO2_BASE + 0x10, 0x0);
	mmio_write_32(GPIO2_BASE + 0x14, 0x0);
	mmio_write_32(GPIO2_BASE + 0x18, 0xffffffff);
	mmio_write_32(GPIO2_BASE + 0x1c, 0x3);

	mmio_write_32(GPIO3_BASE + 0x10, 0x0);
	mmio_write_32(GPIO3_BASE + 0x14, 0x0);
	mmio_write_32(GPIO3_BASE + 0x18, 0xffffffff);
	mmio_write_32(GPIO3_BASE + 0x1c, 0x3);

	mmio_write_32(GPIO4_BASE + 0x10, 0x0);
	mmio_write_32(GPIO4_BASE + 0x14, 0x0);
	mmio_write_32(GPIO4_BASE + 0x18, 0xffffffff);
	mmio_write_32(GPIO4_BASE + 0x1c, 0x3);

	mmio_write_32(GPIO5_BASE + 0x10, 0x0);
	mmio_write_32(GPIO5_BASE + 0x14, 0x0);
